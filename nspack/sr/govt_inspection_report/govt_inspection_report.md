...
|Diam|Fruit Diameter - visible if commodity is SC| `std_fruit_size_counts.marketing_size_range_mm` |
|Cnt|The actual fruit count that fits in a standard box  - visible if the commodity is not SC | `fruit_actual_counts_for_packs.actual_count_for_pack` |
